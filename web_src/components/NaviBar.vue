  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
          <ul class="navbar-nav">
             <li><router-link to="/viedoplay/AboutViedo" class="nav-link">主页</router-link></li>
             <li><router-link to="/viedoplay/AboutViedo" class="nav-link">视频广场</router-link></li> 
             <li><router-link to="/viedoplay/AboutViedo" class="nav-link">实时调阅</router-link></li>
             <li><router-link to="/viedoplay/AboutViedo" class="nav-link">录像回看</router-link></li> 
             <li><router-link to="/about/AboutViedo" class="nav-link">告警查看</router-link></li> 
             <li><router-link to="/AdminLTE" class="nav-link">基础配置</router-link></li> 
          </ul>
