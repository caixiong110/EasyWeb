<template>
    <div class="container-fluid no-padding">
            ...
            <div class="box-header">
                ...
                <form class="form-inline">
                    <div class="form-group">
                      <button type="button" class="btn btn-sm btn-success" @click.prevent="$refs['PlayRTSPDlg'].show()"> 添加摄像机</button>
                   </div> 
        ...
        <PlayRTSPDlg ref="playRTSPDlg" @submit="getPlayers"></PlayRTSPDlg>                
    </div>
</template>

<script>
import prettyBytes from "pretty-bytes";
import PlayRTSPDlg from "components/PlayRTSPDlg.vue"
